<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<!-- adding dropdown that dynamically takes {groups} from composer.js based on current user. -->
			<select name="Type of the post" id="type">
		...
		<!-- Making a checkbox to selecting to post anonymously -->
		<div style = "position:absolute; left:790px; top:90px;">
