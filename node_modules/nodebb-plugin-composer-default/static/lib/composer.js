...
define('composer', [
	...
	async function createNewComposer(post_uuid) {
		...
		// added groups to capture {groups} in the template
		var data = {
	...
	async function post(post_uuid) {
		...
		// added type to capture the selected value from the dropdown.
		var type = postContainer.find("#type").val();
		// added anonymous to capture if the post anonymously checkbox is checked
		var anonymous = postContainer.find("input#anonymous").prop('checked');
		...
		let composerData = {
			uuid: post_uuid,
			// including "type" in the composer data to send it back to the back-end where attribute
			// "type" of the post object is updated with this selected value from the dropdown. 
			type: type,
			// including "anonymous" in the composer data to send it back to the back-end where attribute
			// "isAnonymous" of the post object is updated with checkbox value. 
